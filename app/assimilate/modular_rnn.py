...
class FiniteFieldLinear(torch.nn.ModuleList): # over Module which tracks gradients where as ModuleList doesnt 
    '''
...
class ModularRNN(torch.nn.ModuleList):
    ...
    def __init__(self, d_out, d_in, key, steps=55, activation=ModularTanh(), q=Q):
        super().__init__()
