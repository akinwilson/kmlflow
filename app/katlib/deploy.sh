...
kind create cluster --config  "$SCRIPT_DIR/kind_cluster_deployment.yaml" || 
...
kubectl apply -f "$SCRIPT_DIR/presistent_volume_and_claim.yaml" 
echo ""
...
kubectl apply -f "$SCRIPT_DIR/permissions.yaml"
echo ""
